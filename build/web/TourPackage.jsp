<%-- 
    ...
    Created on : 30 Dec, 2019, 5:02:24 PM
    Author     : rmn
--%>
        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                <form action='<c:url value="SessionServlet"/>' name='MyForm' Method='POST'>
                    <font color='darkblue' size="+4"> Select Destination: </font>
                    <div id=myForm>
<!--                        <select name='Destination' autofocus="true">
                        ...
                        <db:DBListTagHandler tablename="Locations_Country" colname="Place"></db:DBListTagHandler>
                    </div>
